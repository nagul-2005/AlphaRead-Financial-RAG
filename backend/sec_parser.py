...
TICKER_KNOWLEDGE_BASE = {
    ...
    "AMZN": {
        ...
        "Item 8": "Financial Statements (Item 8) for Amazon.com, Inc. (AMZN). Operating cash flows increased substantially. Free cash flow turned strongly positive as capital expenditures rationalized post-pandemic fulfillment expansion."
    },
    "GOOGL": {
        ...
        "Item 8": "Financial Statements (Item 8) for Alphabet Inc. (GOOGL). Massive operating cash generation. Robust balance sheet with extensive cash reserves supporting shareholder returns via share buybacks."
    }
}
